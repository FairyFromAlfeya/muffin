...
exports.keys = exports.giver = exports.nodeUrl = exports.EMPTY_TVM_CELL = exports.ZERO_ADDRESS = exports.getRandomNonce = exports.setNetwork = exports.network = exports.convertCrystal = exports.loadBase64FromFile = exports.loadJSONFromFile = void 0;
...
exports.network = 'local';
const setNetwork = (newNetwork) => {
    exports.network = newNetwork;
};
...
const nodeUrl = () => {
    return JSON
        .parse((0, fs_1.readFileSync)((0, path_1.join)(process.cwd(), 'muffin.config.json'), { encoding: 'utf-8' })).networks[exports.network].url;
};
exports.nodeUrl = nodeUrl;
const giver = () => {
    return JSON
        .parse((0, fs_1.readFileSync)((0, path_1.join)(process.cwd(), 'muffin.config.json'), { encoding: 'utf-8' })).networks[exports.network].giver;
};
exports.giver = giver;
const keys = () => {
    return JSON
        .parse((0, fs_1.readFileSync)((0, path_1.join)(process.cwd(), 'muffin.config.json'), { encoding: 'utf-8' })).networks[exports.network].keys;
};
exports.keys = keys;
